...
def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\dudei\Downloads", uploaded_card.name), "wb") as f:
...
if selected == "Upload and Extract":
    ...
    with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.path.join(os.getcwd(), "C://Users//dudei//Downloads", uploaded_card.name)
